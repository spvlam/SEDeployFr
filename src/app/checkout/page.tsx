...
const CheckoutPage = () => {
  ...
  let [productCart, setProductCart] = useState<Product[]>([])
  ...
  try {
    ...
    if(res){
      ...
      const totalPrice = data.reduce((curTotal: number, item: Product) => {
  ...
  async function comfirmOrder() {
    ...
    let vnPay = await fetch(API_SERVER_CONFIG.payment_url,{
      method:'POST',
      headers:{
        'content-type': 'application/json',
        accessToken,
    ...
    let vnPayUrl = await vnPay.text()
    console.log(vnPayUrl,123,vnPay)
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-[36%] ">
            ...
            <div className="mt-8 divide-y divide-slate-200/70 dark:divide-slate-700 ">
              {productCart.length > 0 && productCart.map(renderProduct)}
            </div>
            ...
            <ButtonPrimary onClick = {comfirmOrder}className="mt-8 w-full">Confirm order</ButtonPrimary>
